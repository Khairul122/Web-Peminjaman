...
if (isset($_POST['simpan'])) {
    ...
    if ($stok < $qty) {
        echo "<script>
            ...
            window.location.href='?view=createpinjambarang';
        </script>";
    } else {
        ...
        try {
            ...
            $insert = mysqli_query($conn, "INSERT into pinjambarang values ('','$id_barang', '$id_user','$qty','$tgl_mulai','$tgl_selesai','$lokasi_barang','$status')");
            $update = mysqli_query($conn, "UPDATE barang SET stok='$sisa' WHERE id='$id_barang'");
